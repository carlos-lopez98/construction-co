...
DELETE FROM ConstructionCo.Contractors WHERE contractor_id = 1;
DELETE FROM ConstructionCo.Purchase_Order WHERE purchase_order_id = 1;
DELETE FROM ConstructionCo.Customers WHERE customer_id = 1;
DELETE FROM ConstructionCo.Employees WHERE employee_id = 1;
DELETE FROM ConstructionCo.Equipment WHERE equipment_id = 1;
DELETE FROM ConstructionCo.Invoices WHERE invoice_id = 1;
DELETE FROM ConstructionCo.Materials WHERE material_id = 1;
DELETE FROM ConstructionCo.Project_Equipment WHERE purchase_order_id = 1;
DELETE FROM ConstructionCo.Purchase_Order_Materials WHERE purchase_order_id = 1;
DELETE FROM ConstructionCo.Suppliers WHERE supplier_id = 1;

ALTER TABLE ConstructionCo.Invoices ADD COLUMN payment_status VARCHAR(20) NULL;
ALTER TABLE ConstructionCo.Materials CHANGE COLUMN price_per_unit price_per_unit DECIMAL(10,2) NULL;
ALTER TABLE ConstructionCo.Contractors ADD COLUMN rating INT NULL;
ALTER TABLE ConstructionCo.Customers MODIFY COLUMN phone_number VARCHAR(20);
ALTER TABLE ConstructionCo.Employees DROP COLUMN hire_date;
